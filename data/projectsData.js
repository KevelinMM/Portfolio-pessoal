const projectsData = [
  ...
  {
    title: 'Pós Graduação Uniplac',
    description: `Site estático para divulgar os cursos de pós graduação da instituição UNIPLAC.`,
    imgSrc: 'https://imgur.com/KmsbLDr.png',
